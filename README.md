# H1 Arduino EMG Code and Workshop from NeurotechUSC and USC IEEE
**bold text** This tutorial was take from DroneBot Workshop's Youtube linked [here](https://www.youtube.com/watch?v=wMVL3d2dN9U&ab_channel=DroneBotWorkshop).
Items Used:
